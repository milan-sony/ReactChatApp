                    ...
                    <div className="bg-white max-w-lg mx-auto shadow px-6 py-7 rounded overflow-hidden dark:bg-slate-900">
                        ...
                        <form autoComplete="off" noValidate onSubmit={handleSubmit}>
                            <div className="space-y-2 mb-2">
                                <div><label className="text-gray-600 dark:text-white mb-2 block">Full Name</label><input type="text" name="fullName" value={formData.fullName} className="block w-full border border-gray-300 px-4 py-3 text-gray-600 text-sm rounded focus:ring-0 focus:outline-custblue placeholder-gray-400 dark:text-white" placeholder="Full name" onChange={handleChange} />
                                </div>
                            </div>
                            <div className="space-y-2 mb-2">
